...
from payabli.core.http_client import (
    AsyncHttpClient,
    HttpClient,
    _build_url,
    get_request_body,
...
from payabli.core.request_options import RequestOptions
...
@patch("payabli.core.http_client.time.sleep", return_value=None)
...
@pytest.mark.asyncio
@patch("payabli.core.http_client.asyncio.sleep", new_callable=AsyncMock)
