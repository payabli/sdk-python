...
from .raw_client import AsyncRawVendorvClient, RawVendorvClient
...
class VendorvClient:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        self._raw_client = RawVendorvClient(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> RawVendorvClient:
        """
    ...
    def add_vendor(
        ...
        *,
        ...
        Examples
        --------
        from payabli import BillingData, Contacts, VendorPaymentMethod, payabli

        client = payabli(
            api_key="YOUR_API_KEY",
        )
        client.vendorv.add_vendor(
            entry="8cfec329267",
            vendor_number="1234",
...
class AsyncVendorvClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._raw_client = AsyncRawVendorvClient(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> AsyncRawVendorvClient:
        """
        Retrieves a raw implementation of this client that returns raw responses.

        Returns
        -------
        AsyncRawVendorvClient
        """
        return self._raw_client
    ...
    async def add_vendor(
        ...
        *,
        ...
        from payabli import Asyncpayabli, BillingData, Contacts, VendorPaymentMethod
        ...
        async def main() -> None:
            await client.vendorv.add_vendor(
                entry="8cfec329267",
                vendor_number="1234",
                name_1="Herman's Coatings and Masonry",
                name_2="<string>",
    ...
    async def delete_vendor(
        ...
        async def main() -> None:
            await client.vendorv.delete_vendor(
                id_vendor=1,
            )
    ...
    async def edit_vendor(
        ...
        *,
        ...
        async def main() -> None:
            await client.vendorv.edit_vendor(
                id_vendor=1,
                name_1="Theodore's Janitorial",
            )
    ...
    async def get_vendor(
        ...
        async def main() -> None:
            await client.vendorv.get_vendor(
                id_vendor=1,
            )
