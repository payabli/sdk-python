...
class VendorQueryRecord(UniversalBaseModel):
    ...
    VendorQueryRecord(
        ...
        payment_portal_url="https://greenfield-landscaping.com/pay",
        card_accepted="yes",
        ach_accepted="unable to determine",
        enrichment_status="fully_enriched",
        enriched_by="web_search",
        enriched_at=datetime.datetime.fromisoformat(
            "2026-03-05 14:22:10+00:00",
        ),
