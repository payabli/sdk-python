...
class ApplicationDataOdp(UniversalBaseModel):
    ...
    contacts: typing.Optional[typing.List[ApplicationDataOdpContactsItem]] = pydantic.Field(default=None)
    """
    ...
    ownership: typing.Optional[typing.List[ApplicationDataOdpOwnershipItem]] = pydantic.Field(default=None)
    """
    ...
    payout_credit_limit: typing_extensions.Annotated[
        PayoutCreditLimit, FieldMetadata(alias="payoutCreditLimit"), pydantic.Field(alias="payoutCreditLimit")
    ]
